...
★★★<b>壊しどころが無い項目</b>(意図的に含めていないもの・裁定196 の正直な扱い):
  ...
  - <b>裁定312(裁定245 と 311 の衝突)の扱い</b> ……
    ★<b>68 の時点では回答が無く、正解が未定なので番人を作れなかった。</b>
    ★★<b>2026-08-26 に裁定312 で確定した(311 が勝つ)。</b>今の実装がそのまま正解であり、
    番人は {@code Batch68SummonFromHandTest#神の福音で出した進化ミニオンも召喚時を発動する}
    である(68 の時点で既に在り、当時は「正しいか分からないものを測っていた」)。
    ★<b>裁定245 は失効した。</b>
