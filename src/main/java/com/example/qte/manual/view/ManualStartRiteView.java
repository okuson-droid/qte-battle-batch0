...
/**
 * 配信に載せる開始シーケンスの儀式1件(★Batch 38 設計書2章)。
 *
 ...
 * <b>状態</b>である。儀式は状態ではなく<b>出来事</b>であり、しかも
 * {@code declarations} とまったく同じ作られ方(配ったログ行の中から拾う)をする。
 * 同じ作られ方のものを同じ場所に置いておくと、ログの末尾60行と1周で作るという
 * 裁定42 の約束が1箇所で守れる。
 *
 * @param seq  元になったログ行の通し番号
 * @param rite そのとき起きた儀式。★中身の構造は {@link ManualLogStartRite} が唯一の正である
 */
public record ManualStartRiteView(int seq, ManualLogStartRite rite) {
}
