...
public final class CardTextKeywords {
     ...
     *
     * <h2>★★★Batch 73: 「<b>の</b>」を足した(裁定303 の一族)</h2>
     * <b>「【X】の◯◯」は、X という性質を持つ何かを指している。</b>
     * Ver1.1 で生まれた4枚がこの形を使っており、どれも自分が X を持つとは書いていない。
     * <ul>
     *   <li>《アルキンティス》(WATER-39)「自分の場の【知識】<b>の枚数</b>Attackを+1する」</li>
     *   <li>《潮獣ビシャカワ》(WATER-36)「自分の【潜伏】<b>の数</b>…」</li>
     *   <li>《ロロイヨ伯爵》(WATER-29)「【守護】<b>の</b>ミニオンが場に出るたび」</li>
     *   <li>《戒律のガーディアン》(LIGHT-20)「自分の光文明の【守護】<b>の</b>コスト-1」</li>
     * </ul>
     *
     * <p>★★<b>実害が出ていたのは1枚だけである。</b>《アルキンティス》は<b>ウェポン</b>であり、
     * 【知識】が付くと {@code GameService.equipWeapon} の
     * 「ウェポンの【知識】は装備時に発動する」を通って<b>装備しただけで1枚引いていた</b>。
     * 残る3枚は種別(スペル・リーダー)や読み手の都合で挙動に出ていなかったが、
     * <b>規則は1つである</b>(裁定130)——「実害が出ていないほう」を残す理由が無い。
     *
     * <p>★★★<b>169枚の凍結({@code keyword-baseline.json})は1枚も動かない。</b>
     * 該当するのは Ver1.1 生まれの3枚と、《戒律のガーディアン》の<b>2つ目の</b>【守護】だけである ——
     * あちらは同じ本文の<b>先頭</b>にも【守護】を持っており(「【守護】自分の光文明スペルの…」)、
     * そちらは付与のまま残るので、抽出結果は {@code [守護]} で変わらない。
     * ★<b>この「1枚の中に付与と参照が同居する」形こそ、
     * 出現ごとに判定する書き方(下の {@code keywordsIn})が守っているものである。</b>
     */
    private static final Pattern REFERENCE = Pattern.compile("^(を持|を与|を付|付与|を行|を得|を失|の)");
